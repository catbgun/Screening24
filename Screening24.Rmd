...
#df24old <- read.table("Scr24_Data_05_V03.txt", skip=0, header=TRUE, sep="\t", na.string=c(""))
...
df24z_finalxy$compound <- revalue(df24z_finalxy$compound, c("CuPT" = "Copper pyrithione"))
...
df24z_finalxyz <- df24z_finalxy %>% 
  mutate(compound = factor(compound, levels = c("Copper pyrithione", "Cu", "Zn", "Tralopyril", 
